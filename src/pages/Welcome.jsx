  ...
  return (
    ...
    <div className='text-center mb-4 bold text-white text-2xl  '>Welcome to Takau Holdings</div>
      <div className="flex  justify-center">
        ...
        <input onChange={(e)=>setemail(e.target.value)} type="text" id="username" name="username" required className="w-1/2 p-2 border border-black rounded" />
      </div>
      <div className="flex  justify-center mt-8 mb-8">
        <label htmlFor="password" className="mb-1 lex items-cente text-white ">Password:</label>
        <input    onChange={(e)=>setpassword(e.target.value)}  type="password" id="password" name="password" required className="w-1/2 p-2 border border-black rounded" />
      </div>
      <div className=" text-white flex justify-center">
        <button    className="px-4 py-2 bg-red-400 text-white rounded ">Log In</button>
      </div>
     </form>
  </div>
  )
