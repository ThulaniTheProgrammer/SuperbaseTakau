...
<div><Link to="/SighnUp" className='rounded-lg flex font-bold items-center text-white py-2 bg-red-500 px-5'>Add Admistrator</Link></div>
<div className='flex flex-col'>
  <div className='bg-black px-1 w-8 rounded-full mx-8'>
  </div>


  <div className='mr-10'> <Link to="/SighnUp" className='rounded-lg flex font-bold items-center py-2 text-white bg-red-500 px-5'>Add Cashier</Link></div>
</div>
    </div>
...
<Stock />
   ...
   /*
            <div> <Link to="/AddAdministrator" className='rounded-lg flex font-bold items-center text-white bg-red-500 px-5'>Add Admistrator</Link></div>
           <div>  <Link to="/AddCashier" className='rounded-lg flex font-bold items-center text-white bg-red-500 px-5'>Add Cashier</Link></div>
        */